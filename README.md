...
📝 Notas Importantes
Banco de Dados: O H2 Database é um banco em memória, portanto os dados serão perdidos ao reiniciar a aplicação
Validação de Conflitos: O sistema verifica disponibilidade considerando 1 hora de duração por agendamento
Formato de Data: Use o padrão ISO-8601 para datas: YYYY-MM-DDTHH:MM:SS
Fusos Horários: A aplicação opera em horário local (sem suporte a múltiplos fusos)
🔄 Próximas Melhorias
...
👨‍💻 Autor
Desenvolvido pelo time IRP

📞 Suporte
Para dúvidas ou sugestões, abra uma issue no repositório ou entre em contato com o time de desenvolvimento.
